...
# por peso de cada paquete así que deben calcular el peso de los payasos y muñecas que saldrán en cada paquete a demanda.
...
payasos = int(input("¿Cuántos payasos se han vendido?"))

muñecas = int(input("¿cuántas muñecas se han vendido?"))

peso_paquete = (payasos*112) + (muñecas*75)

print("El paquete pesará ", peso_paquete/1000, "Kg")